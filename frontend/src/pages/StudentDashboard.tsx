        ...
        <div className="max-w-7xl mx-auto space-y-8">
          <div className="fade-in-up">
            <div className="flex items-center gap-4 mb-4">
              <div className="w-12 h-12 rounded-xl bg-gradient-student shadow-glow flex items-center justify-center">
                <Calendar className="w-6 h-6 text-white" />
              </div>
              <div>
                <h1 className="heading-lg gradient-text">My Dashboard</h1>
